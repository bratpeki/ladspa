...
static void connectPortToAmplifier(
	...
	switch (Port) {
		...
		case AMP_OUTPUT1:
			...
			break;
		case AMP_INPUT2: /* Stereo */
			psAmplifier->m_pfInputBuffer2 = DataLocation;
			break;
		case AMP_OUTPUT2: /* Stereo */
